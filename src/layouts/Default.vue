<template>
  ...
  <div class="homefooter" >
        ...
        <div class="is-flex is-flex-wrap-nowrap is-align-content-flex-end	">
                ...
                <a href="mailto:bark@dogtic.com" aria-label="Email" >
                ...
                <div class="navbar-item">
                <a href="https://github.com/jsappme/gridsome-shopify-starter" rel="noreferrer" aria-label="GitHub" target="_blank" >
            ...
            <div class="navbar-item">
                <a href="https://twitter.com/herve76" rel="noreferrer" aria-label="Twitter"  target="_blank" >
            ...
            <div class="navbar-item">
                <a href="https://www.linkedin.com/in/hervefulchiron/" rel="noreferrer" aria-label="LinkedIn"  target="_blank" >
